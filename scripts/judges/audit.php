...
# DJM, 2017-03-09
# Print the list of judges who should be current
# Usage: sudo -u www-data drush -r $D7 -l www.iac.org scr audit.php [v]
...
foreach($judges as $jid=>$judge) {
  ...
  // Anyone who has judged 30 total flights, or 25 flights of which 5 are ADV or UNL,
  // or who has attended a judge's school in the past two years is current judge of some sort.
  if ($judge['total'] >= 30 ||
    ($judge['total'] >= 25 && $judge['adv_unl_free'] >= 5) ||
